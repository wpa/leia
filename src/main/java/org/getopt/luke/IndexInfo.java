...
public class IndexInfo {
  ...
  public IndexInfo(final IndexReader reader, final String indexPath) throws Exception {
    this.reader = reader;
    this.dir = null;
    this.dirImpl = "N/A";
  ...
  private void countTerms() throws Exception {
    ...
    while (fe.hasNext() && (fld = fe.next()) != null) {
      final FieldTermCount ftc = new FieldTermCount();
      ftc.fieldname = fld;
      final Terms terms = fields.terms(fld);
